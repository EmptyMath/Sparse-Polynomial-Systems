...
degree = 0;
for k = 1:Size_J(2)
    degree = max(degree,degreePolynomial(Polynomial_Basis{k}));
end

Monomials = Construct_Monomials_standard(degree,Variables,zeros(1,Variables));
...
[Border_Basis,C_0] = BorderBasis_standard(Polynomial_Basis,Variables,tol);
